...
export function toProvider(dbProvider: any): Provider {
  return {
    ...
    allowedModels: dbProvider?.allowedModels ?? null,
    codexInstructionsStrategy: dbProvider?.codexInstructionsStrategy ?? "auto",
    codexClientSpoofing: dbProvider?.codexClientSpoofing ?? false,
    claudeClientSpoofing: dbProvider?.claudeClientSpoofing ?? false,
